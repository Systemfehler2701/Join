...
function renderSummaryHeader() {
    return /* html */ `<div class="summary-header">
    <h1>Join 360</h1>
...
function renderSummaryTodoSvg() {
    return /* html */ `<svg width="69" height="70" viewBox="0 0 69 70" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function renderSummaryDoneSvg() {
    return /* html */ `<svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function renderSummaryUpcoming() {
    return /* html */ `<div class="summary-upcoming">
...
function renderSummaryBoard() {
    return /* html */ `<div class="summary-board">
...
function renderSummaryProgress() {
    return /* html */ `<div class="summary-progress">
...
function renderSummaryFeedback() {
    return /* html */ `<div class="summary-feedback">
...
function renderSummaryWelcome() {
    return /* html */ `<div class="summary-welcome">
